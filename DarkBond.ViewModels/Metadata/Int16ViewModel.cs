// <copyright file="Int16ViewModel.cs" company="Dark Bond, Inc.">
...
namespace DarkBond.ViewModels
{
    ...
    /// </summary>
    public class Int16ViewModel : TextViewModel
    {
        /// <summary>
        /// The date.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Int16ViewModel"/> class.
        /// </summary>
        public Int16ViewModel()
        {
        ...
        /// <summary>
        /// Handles a change to the <see cref="short"/> property.
        /// </summary>
        private void OnPropertyChanged()
        {
            // Format the text that is displayed and then signal the view that new text is available.
            this.Text = this.int16Field.ToString(this.formatField, CultureInfo.InvariantCulture);
        }
    }
}