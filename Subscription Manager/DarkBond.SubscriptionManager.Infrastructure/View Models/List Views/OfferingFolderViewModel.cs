...
namespace DarkBond.SubscriptionManager.ViewModels.ListViews
{
    ...
    /// <summary>
    /// View model for the offering folder when it appears as an item in a list.
    /// </summary>
    public class OfferingFolderViewModel : CommonListViewViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// The command to open a offering folder.
        /// </summary>
        private DelegateCommand offeringFolderOpen;
            ...
            : base(compositionContext, dataModel, subscriptionService)
        {
            ...
            this.Count = this.DataModel.Offering.Count;
            this.ImageKey = ImageKeys.Folder;
            this.Name = Resources.Product;

            // This will tell us when the number of offerings has changed.
            this.DataModel.Offering.CollectionChanged += this.OnOfferingsChanged;

            // These commands are handled by this view model.
            this.offeringFolderOpen = new DelegateCommand(
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                if (this.IsSelected)
                {
                    GlobalCommands.Open.UnregisterCommand(this.offeringFolderOpen);
                }
            }
        ...
        protected override void OnIsSelectedChanged()
        {
            ...
            if (this.IsSelected)
            {
                GlobalCommands.Open.RegisterCommand(this.offeringFolderOpen);
            }
            else
            {
                GlobalCommands.Open.UnregisterCommand(this.offeringFolderOpen);
        ...
        private void OnOfferingsChanged(object sender, NotifyCollectionChangedEventArgs notifyCollectionChangedEventArgs)
        {
