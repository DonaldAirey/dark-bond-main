...
namespace DarkBond.SubscriptionManager.ViewModels.Breadcrumbs
{
    ...
    /// <summary>
    /// A breadcrumb for the folder that displays offerings.
    /// </summary>
    public class OfferingFolderViewModel : CommonBreadcrumbViewModel
    {
        /// <summary>
        ...
        public OfferingFolderViewModel(CompositionContext compositionContext, DataModel dataModel)
