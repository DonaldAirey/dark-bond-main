...
namespace DarkBond.LicenseManager.ViewModels.ListViews
{
    ...
    /// <summary>
    /// View model for the customer folder when it appears as an item in a list.
    /// </summary>
    public class CustomerFolderViewModel : CommonListViewViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// The command to open a customer folder.
        /// </summary>
        private DelegateCommand customerFolderOpen;
            ...
            : base(compositionContext, dataModel, licenseService)
        {
            ...
            this.Count = this.DataModel.Customer.Count;
            this.ImageKey = ImageKeys.Folder;
            this.Name = Resources.Customer;

            // This will tell us when the number of customers has changed.
            this.DataModel.Customer.CollectionChanged += this.OnCustomersChanged;

            // These commands are handled by this view model.
            this.customerFolderOpen = new DelegateCommand(
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                if (this.IsSelected)
                {
                    GlobalCommands.Open.UnregisterCommand(this.customerFolderOpen);
                }
            }
        ...
        protected override void OnIsSelectedChanged()
        {
            ...
            if (this.IsSelected)
            {
                GlobalCommands.Open.RegisterCommand(this.customerFolderOpen);
            }
            else
            {
                GlobalCommands.Open.UnregisterCommand(this.customerFolderOpen);
        ...
        private void OnCustomersChanged(object sender, NotifyCollectionChangedEventArgs notifyCollectionChangedEventArgs)
        {
