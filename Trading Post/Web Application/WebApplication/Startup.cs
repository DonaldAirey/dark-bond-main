...
namespace DarkBond.TradingPost
{
    ...
    using DarkBond.TradingPost.RestService;
    ...
    public class Startup
    {
        ...
        {
            // This allows us to explicitly create services.
            ...
            this.serviceCollection.AddMvc().AddApplicationPart(typeof(ProductsController).Assembly);
        }
