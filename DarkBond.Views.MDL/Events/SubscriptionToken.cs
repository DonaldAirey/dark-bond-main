// <copyright file="SubscriptionToken.cs" company="DarkBond, Inc.">
...
namespace DarkBond.View.Events
{
    ...
    /// </summary>
    [SuppressMessage("Microsoft.Design", "CA1063:ImplementIDisposableCorrectly", Justification = "Should never have a need for a finalizer, hence no need for Dispose(Boolean)")]
    public class SubscriptionToken : IEquatable<SubscriptionToken>, IDisposable
    {
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1063:ImplementIDisposableCorrectly", Justification = "Should never have need for a finalizer, hence no need for Dispose(Boolean).")]
